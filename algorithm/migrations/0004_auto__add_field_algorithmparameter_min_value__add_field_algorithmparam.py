...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlgorithmParameter.min_value'
        db.add_column(u'algorithm_algorithmparameter', 'min_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlgorithmParameter.max_value'
        db.add_column(u'algorithm_algorithmparameter', 'max_value',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlgorithmParameter.min_value'
        db.delete_column(u'algorithm_algorithmparameter', 'min_value')

        # Deleting field 'AlgorithmParameter.max_value'
        db.delete_column(u'algorithm_algorithmparameter', 'max_value')
