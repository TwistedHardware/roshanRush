...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrainedModelFeature.pre_process'
        db.alter_column(u'algorithm_trainedmodelfeature', 'pre_process_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['algorithm.DataProcess'], null=True))

    def backwards(self, orm):

        # Changing field 'TrainedModelFeature.pre_process'
        db.alter_column(u'algorithm_trainedmodelfeature', 'pre_process_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['algorithm.DataProcess']))
