...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlgorithmParameter.help'
        db.alter_column(u'algorithm_algorithmparameter', 'help', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'AlgorithmParameter.help'
        db.alter_column(u'algorithm_algorithmparameter', 'help', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
