...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TrainedModel.predection'
        db.delete_column(u'algorithm_trainedmodel', 'predection')

        # Adding field 'TrainedModel.prediction'
        db.add_column(u'algorithm_trainedmodel', 'prediction',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TrainedModel.predection'
        db.add_column(u'algorithm_trainedmodel', 'predection',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TrainedModel.prediction'
        db.delete_column(u'algorithm_trainedmodel', 'prediction')
