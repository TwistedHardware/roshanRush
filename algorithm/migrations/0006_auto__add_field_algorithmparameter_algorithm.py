...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlgorithmParameter.algorithm'
        db.add_column(u'algorithm_algorithmparameter', 'algorithm',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['algorithm.Algorithm']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlgorithmParameter.algorithm'
        db.delete_column(u'algorithm_algorithmparameter', 'algorithm_id')
