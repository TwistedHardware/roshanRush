...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Algorithm.predection'
        db.delete_column(u'algorithm_algorithm', 'predection')

        # Adding field 'Algorithm.prediction'
        db.add_column(u'algorithm_algorithm', 'prediction',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Algorithm.predection'
        db.add_column(u'algorithm_algorithm', 'predection',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Algorithm.prediction'
        db.delete_column(u'algorithm_algorithm', 'prediction')
