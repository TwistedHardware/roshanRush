...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrainedModel.training_percentage'
        db.add_column(u'algorithm_trainedmodel', 'training_percentage',
                      self.gf('django.db.models.fields.FloatField')(default=0.5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrainedModel.training_percentage'
        db.delete_column(u'algorithm_trainedmodel', 'training_percentage')
