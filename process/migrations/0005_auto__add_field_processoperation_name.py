...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProcessOperation.name'
        db.add_column(u'process_processoperation', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProcessOperation.name'
        db.delete_column(u'process_processoperation', 'name')
